...
namespace rest\providers\sms;

use Exception;
use rest\providers\sms\Pest;
...
class SMSClient extends Pest {
	 ...
	 * @access protected
	 */
	protected $m_login = "2611_kimberli";
	/**
	 * Сохраненный пароль
	 *
	 * @access protected
	 */
	protected $m_password = "Kimberli2019";
	 ...
	 *
	 */
	protected $sourceAddres = "Kimberli";
	...
	public function getBalance() {
		return ['balance' => SMSClient::getBalance_St($this->m_sessionID)];
	}
	...
	public function getSMSState($messageID) {
		return SMSClient::getSMSState_St($this->m_sessionID, $messageID);
	}

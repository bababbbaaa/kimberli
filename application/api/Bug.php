...
class Bug extends Okay {
    ...
    public function add_exception($e): bool
	{
		...
		@file_get_contents('https://api.telegram.org/bot539849731:AAH9t4G2hWBv5tFpACwfFg3RqsPhK4NrvKI/sendMessage?chat_id=' . 404070580 . '&text=222' . urlencode($e->getMessage())).'&parse_mode=HTML';

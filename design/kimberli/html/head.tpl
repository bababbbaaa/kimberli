...
{if $module == 'ProductView'}
    <meta name="image" content="{$product->image->filename|resize:330:300}">
...
{elseif $module == 'BlogView'}
    ...
    {if $post->image}
        <meta name="image" content="{$post->image|resize:400:300:false:$config->resized_blog_dir}">
    ...
    {else}
        <meta name="image" content="{$config->root_url}/design/{$settings->theme}/images/{$settings->site_logo}">

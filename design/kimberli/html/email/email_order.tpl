                                                ...
                                                <span style="font-size:18px;">
                                                    <span style="font-family:trebuchet ms,helvetica,sans-serif;">
                                                        <span style="color:#333333;">
                                                            <strong>{$lang->company_phone_1}</strong>
                                                        </span>
                                                    </span>
                                                </span>
                                            </div>
                                            ...
                                            <div style="text-align: left; font-family: 'Trebuchet MS'; font-size: 14px; color: rgb(51, 51, 51); line-height: 1.5">
                                                <table width="100%" style="padding: 5px;font-family: 'Trebuchet MS'; font-size: 14px; color: rgb(51, 51, 51); line-height: 1.5">
                                                    ...
                                                    {foreach $purchases as $purchase}
                                                        <tr>
                                                            <td valign="middle">
                                                                <a href="{$config->root_url}/{$lang_link}products/{$purchase->variant->url}">
                                                            ...
                                                            <td valign="middle">
                                                                <a href="{$config->root_url}/{$lang_link}products/{$purchase->variant->url}" style="font-family: 'Trebuchet MS'; font-size: 14px; color: rgb(29, 103, 164); text-decoration: underline">{$purchase->product_name|escape}</a><br />
                                                                <span style="font-family:verdana,geneva,sans-serif;"><em><span style="color: rgb(128, 128, 128); font-size: 11px;">{$purchase->variant_name|escape} - {$purchase->variant->sku}</span></em></span>
                                                            ...
                                                            <td align="right" nowrap="nowrap" valign="middle">
                                                                <b>{$purchase->price}&nbsp;{$currency->sign}</b>
                                                            </td>
                                                        </tr>
                                                    {/foreach}
                                                    </tbody>
                                            ...
                                            <div style="text-align: left; font-family: 'Trebuchet MS'; font-size: 14px; color: rgb(51, 51, 51); line-height: 1.5">
                                                <table cellpadding="4" cellspacing="0" width="100%" style="padding: 5px;font-family: 'Trebuchet MS'; font-size: 14px; color: rgb(51, 51, 51); line-height: 1.5">
                                                    ...
                                                    {if $order->separate_delivery || !$order->separate_delivery && $order->delivery_price > 0}
                                                        <tr>
                                                            ...
                                                            {if !$order->separate_delivery}
                                                                <td align="right" nowrap="nowrap" valign="middle">{$order->delivery_price}&nbsp;{$currency->sign}</td>
                                                            {else}
                                                                <td></td>
                                                            {/if}
                                                        </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="right" nowrap="nowrap" valign="middle"><b><span style="font-size:16px;">{$order->total_price}&nbsp;{$currency->sign}</span></b></td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                            </div>

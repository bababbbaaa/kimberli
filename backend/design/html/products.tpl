                    ...
                    <div class="col-md-3 col-lg-3 col-sm-12">
                        <div>
                            <select id="id_filter" name="products_filter" class="selectpicker form-control" title="{$btr->products_filter|escape}" data-live-search="true" onchange="location = this.value;">
                                ...
                                <option value="{url keyword=null brand_id=null category_id=null page=null limit=null filter='in_stock'}" {if $filter == 'in_stock'}selected{/if}>{$btr->products_in_stock|escape}</option>
                                <option value="{url keyword=null brand_id=null category_id=null page=null limit=null filter='new'}" {if $filter == 'new'}selected{/if}>{$btr->products_new|escape}</option>
                                ...
                                <div class="fn_row okay_list_body_item fn_sort_item">
                                    <div class="okay_list_row">
                                        ...
                                        <div class="okay_list_boding okay_list_name">
                                            ...
                                            {/if}
                                            {if $product->xml}
                                                <div class="okay_list_name_brand">XML : <b>{$product->xml|escape}</b></div>
                                            {/if}
                            ...
                            <div class="okay_list_foot_left">
                                ...
                                <div class="okay_list_option">
                                    <select name="action" class="selectpicker products_action">
                                        ...
                                        {/if}
                                        {if $categories_xml|count>1}
                                            <option value="move_to_xml_category">{$btr->products_move_to_category|escape}_xml</option>
                                        {/if}
                                ...
                                <div class="col-lg-8 col-md-6 col-sm-12 fn_additional_params">
                                    ...
                                    <div class="fn_move_to_category col-lg-12 col-md-12 col-sm-12 hidden fn_hide_block">
                                        ...
                                        <div class="fn_move_to_xml_category col-lg-12 col-md-12 col-sm-12 hidden fn_hide_block">
                                        <select name="target_xml_category" class="selectpicker" data-live-search="true" data-size="10">
                                            {function name=category_select_xml level=0}
                                                {foreach $categories_xml as $category}
                                                    <option value='{$category->category_id}'>{section sp $level}&nbsp;&nbsp;&nbsp;&nbsp;{/section}{$category->name|escape}</option>
                                                {/foreach}
                                            {/function}
                                            {category_select_xml categories_xml=$categories_xml}
                                        </select>
                                    </div>

    ...
    <div class="row">
        <div class="col-lg-4 col-md-12 pr-0">
            <div class="boxed fn_toggle_wrap min_height_210px">
                <div class="heading_box">
                    {$btr->general_image|escape} 1920px * 537px
                ...
                <div class="row">
                    <div class="col-lg-12 toggle_body_wrap on fn_card">
                        ...
                        <div class="row">
                            ...
                            <option value="0" {if !$post->compilation_id}selected=""{/if} data-brand_name="">{$btr->general_not_set|escape}</option>
                            {foreach $compilations as $c}
                                <option value="{$c->compilation_id}" {if $post->compilation_id == $c->compilation_id}selected=""{/if} data-compilation_name="{$c->name|escape}">{$c->name|escape}</option>
                            {/foreach}
                        </select>
                                </div>
                            </div>

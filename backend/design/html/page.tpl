...
<form method="post" enctype="multipart/form-data" class="fn_fast_button">
    ...
    <div class="row">
        <div class="col-lg-4 col-md-12  hidden-sm-down">
            <div class="boxed fn_toggle_wrap min_height_200px">
                <div class="heading_box">
                            ...
                            <input type="hidden" class="fn_accept_delete" name="delete_image" value="">
                                <div class="fn_parent_image">
                                    <div class="category_image image_wrapper fn_image_wrapper text-xs-center">
                                        ...
                                        <img src="{$page->image|resize:300:120:false:$config->resized_pages_dir}" alt="" />
                                    </div>
                                </div>
                            {else}
                                <div class="fn_parent_image"></div>
                            {/if}
                            <div class="fn_upload_image dropzone_block_image {if $page->image} hidden{/if}">
                    ...
                    <div class="col-lg-12 col-md-9 col-sm-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-12 col-sm-12">
                               <div class="">
                                    <div class="heading_label" >{$btr->compilations_menu|escape}</div>
                            <select name="compilation_id" class="selectpicker mb-1">
                            <option value="0" {if !$page->compilation_id}selected=""{/if} data-brand_name="">{$btr->general_not_set|escape}</option>
                            {foreach $compilations as $c}
                                <option value="{$c->compilation_id}" {if $page->compilation_id == $c->compilation_id}selected=""{/if} data-compilation_name="{$c->name|escape}">{$c->name|escape}</option>
                            {/foreach}
                        </select>
                                </div>
                            </div>

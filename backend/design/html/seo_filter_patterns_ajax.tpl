        ...
        {foreach $patterns as $p}
            <div class="fn_{$p->type}{if $p->feature_id}_{$p->feature_id}{/if} fn_template_block">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="row">
                             <div class="col-md-12 pr-0 hidden-sm-down">
                            ...
                            <input type="hidden" class="fn_accept_delete" name="delete_image" value="">
                                <div class="fn_parent_image">
                                    <div class="category_image image_wrapper fn_image_wrapper text-xs-center">
                                        ...
                                        <img src="{$p->image|resize:300:120:false:$config->resized_filter_patterns_dir}" alt="" />
                                    </div>
                                </div>
                            {else}
                                <div class="fn_parent_image"></div>
                            {/if}
                            <div class="fn_upload_image dropzone_block_image {if $p->image} hidden{/if}">
                                <i class="fa fa-plus font-5xl" aria-hidden="true"></i>
                                <input class="dropzone_image" name="seo_filter_patterns[image][]" type="file" />
                            </div>

...
db_user = xnosdzcp_kimberli

;Пароль к базе
db_password = "NEBZFlJMW7"

;Имя базы
db_name = xnosdzcp_kimberli
...
;Изображения оригиналов и нарезок фоток страниц
original_pages_dir = files/pages/
resized_pages_dir = files/pages_resized/

;Изображения оригиналов и нарезок фоток сео фильтров
original_filter_patterns_dir = files/filter_patterns/
resized_filter_patterns_dir = files/filter_patterns_resized/
